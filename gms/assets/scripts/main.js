...
if (item) {
    ...
    window.addEventListener("optimizedScroll", function () {
        if (item[0]) {
            item[0].style.transform = "translate( 0%, -" + window.scrollY * 0.03 + "%)";
        }
        if (item[1]) {
            item[1].style.transform = "translate( 0%, -" + window.scrollY * 0.02 + "%)";
        }
        if (item[2]) {
            item[2].style.transform = "translate( 0%, -" + window.scrollY * 0.07 + "%)";
        }
    })
}
...
if (t) {
    ...
    var mouse = {
        ...
        setOrigin: function (e) {
            this._x = e.offsetLeft + Math.floor(e.offsetWidth / 5);
            this._y = e.offsetTop + Math.floor(e.offsetHeight / 5);
        },
        show: function () {
...
// Track the mouse position relative to the center of the container.
    ...
    var updateTransformStyle = function (x, y) {
        var style = "rotateZ(" + x * 45 + "deg) rotateZ(" + y * 45 + "deg)";
